...
urlPatterns = {	"/restricted/admin/*", "/restricted/alumno/*" },
initParams = { @WebInitParam(name = "InitPage", value = "/restricted/profesor/index.xhtml", description = "Pagina de inicio"),
			   @WebInitParam(name = "LoginParam", value = "/../../logueo.xhtml", description = "Pagina de logueo") })
public class LoginVerifierProfesor implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		else if (loggeedin instanceof Profesor) {
