...
urlPatterns = {	"/restricted/admin/*", "/restricted/profesor/*" },
initParams = { @WebInitParam(name = "InitPage", value = "/restricted/alumno/index.xhtml", description = "Pagina de inicio"),
			   @WebInitParam(name = "LoginParam", value = "/../../logueo.xhtml", description = "Pagina de logueo") })
public class LoginVerifierAlumno implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		else if (loggeedin instanceof Alumno) {
