 ...
 */
@WebFilter(dispatcherTypes = { DispatcherType.REQUEST }, description = "Filtro de seguridad", urlPatterns = { "/restricted/*" }, initParams = { @WebInitParam(name = "LoginParam", value = "/logueo.xhtml", description = "Pagina de loggeo") })
